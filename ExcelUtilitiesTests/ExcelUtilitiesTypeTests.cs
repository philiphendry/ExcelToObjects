...
public class ExcelUtilitiesTypeTests
{
    ...
    {
        var result = _excelToObjects.ReadData<InvalidDoubleColumnWorksheet>(_testFilename);
    ...
    {
        var result = _excelToObjects.ReadData<InvalidIntegerColumnWorksheet>(_testFilename);
    ...
    {
        var result = _excelToObjects.ReadData<InvalidDateColumnWorksheet>(_testFilename);
    ...
    {
        var result = _excelToObjects.ReadData<InvalidDateTimeColumnWorksheet>(_testFilename);
    ...
    {
        var result = _excelToObjects.ReadData<InvalidTimeOnlyColumnWorksheet>(_testFilename);
    ...
    {
        var result = _excelToObjects.ReadData<InvalidAccountingColumnWorksheet>(_testFilename);
        Assert.That(result.IsValid, Is.False, "The string data should not map to the double type.");
        Assert.That(result.ValidationProblems[0].Message, Is.EqualTo("The cell TypeTests!A1 has the value 'one' which cannot be interpreted as the data type 'Double'."));
    }
    ...
    {
        var result = _excelToObjects.ReadData<InvalidCurrencyColumnWorksheet>(_testFilename);
        Assert.That(result.IsValid, Is.False, "The string data should not map to the double type.");
        Assert.That(result.ValidationProblems[0].Message, Is.EqualTo("The cell TypeTests!A1 has the value 'one' which cannot be interpreted as the data type 'Double'."));
    }
}